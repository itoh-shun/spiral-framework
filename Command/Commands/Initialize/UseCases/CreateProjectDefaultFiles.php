...
class CreateProjectDefaultFiles {
    ...
    public static function execute($inputdata)
    {
        ...
        $text = View::forge('spiral-framework/Command/Samples/StartUp/web',compact('projectName'));
        file_put_contents("src/{$projectName}/StartUp/web.php", $text);
        
        $text = View::forge('spiral-framework/Command/Samples/StartUp/api',compact('projectName'));
        ...
        $text = View::forge('spiral-framework/Command/Samples/Exceptions/ExceptionHandler',compact('projectName'));
        file_put_contents("src/{$projectName}/Exceptions/ExceptionHandler.php", $text);
        
        $text = View::forge('spiral-framework/Command/Samples/InterfaceAdapters/Controlers/WelcomeController',compact('projectName'));
